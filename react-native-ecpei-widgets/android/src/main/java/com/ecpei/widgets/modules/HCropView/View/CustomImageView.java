...
//        }
     ...
     * degrees 用于自己控制旋转角度
     */
    public void clickRotation(int angles) {
        mCurrentMatrix.postRotate(angles, mBoundRectF.centerX(), mBoundRectF.centerY());
        transform();
    }
    ...
    public Bitmap clip(int width,int height){
        ...
        return Bitmap.createBitmap(bitmap,(int)x, (int)y ,width,height);
    }
}
